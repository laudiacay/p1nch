...
import { BigIntish, configs } from '@pinch-ts/common';
...
interface WithdrawalData {
  ...
  new_deactivator_ticket_hash: BigIntish;
  old_ticket_hash_commitment: BigIntish;
  old_ticket_commitment_inclusion_proof: Proof;
  prior_root: BigIntish;
  token: string;
  amount: BigIntish;
  recipient: string;
}
...
interface MergeData {
  ...
  old_p2skh_ticket_commitment_1: BigIntish;
  old_p2skh_ticket_commitment_2: BigIntish;
  old_p2skh_deactivator_ticket_1: BigIntish;
  old_p2skh_deactivator_ticket_2: BigIntish;
  well_formed_new_p2skh_ticket_proof: BigIntish;
  new_p2skh_ticket: BigIntish;
}

interface SplitData {
  well_formed_deactivator_for_p2skh: Proof;
  old_p2skh_ticket_commitment: BigIntish;
  old_p2skh_deactivator_ticket: BigIntish;
  well_formed_new_p2skh_tickets_proof: Proof;
  new_p2skh_ticket_1: BigIntish;
  new_p2skh_ticket_2: BigIntish;
}
...
export class ContractController extends Controller {
  ...
  public async deposit(
    ...
    @Res() succuss: TsoaResponse<200, { message: string }>
  ): Promise<string> {
    ...
    return succuss(200, { message: 'success' });
  }
